                                ...
                                <div class="col-12">
                                    <form action="{{route('program.update' , [$program->id])}}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" required name="title" value="{{$program->title}}" class="form-control rounded" id="inputName4" placeholder="Name" />
                                        </div>

                                        <div class="form-row">
                                            <div class="card-body">
                                                <textarea name="desc" class="summernote">{!! $program->desc !!}</textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <div class="item col-12 col-md-6 col-lg-4 mb-4 text-center Branding">                                       
                                                <img src="{{asset($program->upload)}}" alt="" class="portfolioImage img-fluid">
                                                <div class="d-flex">
                                                    <a data-fancybox-group="gallery" href="{{asset($program->upload)}}" class="fancybox btn rounded-0 btn-dark w-100">View Large</a>                            
                                                </div>
                                            </div>
                                        </div>
                                        @endif
                                        ...
                                        <div class="custom-file">
                                            <input type="file" class="custom-file-input" name="upload" id="validatedCustomFile" accept=".png,.jpg"  @if($program->upload == '') required @endif>
