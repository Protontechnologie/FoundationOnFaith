            ...
            <div class="col-12 mt-4">
                <div class="card">
                    <div class="card-header">
                        <h6 class="card-title">Membership Form</h6>
                    </div>
                                    ...
                                    <form action="{{route('membership.store')}}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-row"> 
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <input type="text" required name="title" class="form-control rounded" id="inputName4" placeholder="Name" />
                                            </div>
                                            <div class="form-group col-md-4">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <input type="number" min="0" required name="price" class="form-control rounded" id="price" placeholder="Enter the amount" step="0.01"/>
                                        </div>
