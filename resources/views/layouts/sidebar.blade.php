                    ...
                    <li class="dropdown"><a href="#"><i class="icon-organization mr-1"></i> Management</a>
                        <ul>
                            ...
                            <li class="dropdown"><a href="#"><i class="icon-options"></i>Category</a>
                                <ul class="sub-menu">
                                    <li><a href="{{route('category.create')}}"><i class="icon-energy"></i> Create</a></li>
                                    <li><a href="{{route('category.index')}}"><i class="icon-energy"></i> View</a></li>
                                </ul>
                            </li>

                            <li class="dropdown"><a href="#"><i class="icon-options"></i>Product</a>
                                <ul class="sub-menu">
                                    <li><a href="{{route('product.create')}}"><i class="icon-energy"></i> Create</a></li>
                                    <li><a href="{{route('product.index')}}"><i class="icon-energy"></i> View</a></li>
                                </ul>
                            </li>
                            --}}
                        </ul>
                    ...
                    <li class="dropdown"><a href="#"><i class="icon-organization mr-1"></i> Tools</a>
                        <ul>
                            <li class="dropdown"><a href="#"><i class="icon-options"></i>Reports</a>
                                <ul class="sub-menu">
                                    <li><a href="{{route('registered_user_report')}}"><i class="icon-energy"></i> All Registered User</a></li>
                            ...
                            <li class="dropdown"><a href="#"><i class="icon-options"></i>Payroll</a>
                                <ul class="sub-menu">
                                    <li><a href="{{route('payroller')}}"><i class="icon-energy"></i> Users Payroll</a></li>
                                </ul>
                            </li>
