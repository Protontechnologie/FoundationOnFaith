<div id="header-fix" class="header fixed-top">
            <div class="site-width">
                <nav class="navbar navbar-expand-lg  p-0">
                    <div class="navbar-header  h-105 h4 align-self-center logo-bar text-left">  
                        <a href="{{route('web.index')}}" class="horizontal-logo text-left">
                        <img class="logo p-2" src="{{asset('web/assets/images/logo.png')}}" width="125px" alt="{{env('APP_NAME')}}">           
                        </a>                   
                    </div>
