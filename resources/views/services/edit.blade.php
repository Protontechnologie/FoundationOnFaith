                                ...
                                <div class="col-12">
                                    <form action="{{route('services.update' , [$service->id])}}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" required name="title" value="{{$service->title}}" class="form-control rounded" id="inputName4" placeholder="Name" />
                                        </div>

                                        <div class="form-row">
                                            <div class="card-body">
                                                <textarea name="details" class="summernote">{!! $service->details !!}</textarea>
                                            </div>
                                        </div>
