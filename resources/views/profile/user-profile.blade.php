        ...
        <div class="row">
            <div class="col-12 mt-3">
                <div class="position-relative">
                    ...
                    <div class="position-relative px-3 py-5">
                        <div class="media d-md-flex d-block">
                            @if($user->profile_pic != "") @php $path = $user->profile_pic; @endphp @else @php $path = "images/no-img.png"; @endphp @endif
                ...
                <div class="card-content">
                    <div class="card-body">
                        <div class="row">
                            <ul class="col-12 nav nav-tabs d-block d-sm-flex">
                                <li class="nav-item mb-4 mr-4">
                                    <a class="nav-link nav-link_click p-0 active" data-tabname="tab1" data-toggle="tab" href="#tab1">
                                        <div class="d-flex">
                                ...
                                <li class="nav-item mb-4 mr-4">
                                    <a class="nav-link nav-link_click p-0" data-tabname="tab4" data-toggle="tab" href="#tab4">
                                        <div class="d-flex">
                                            <div class="mr-3 mb-0 h1">2</div>
                                            <div class="media-body align-self-center">
                                                <h6 class="mb-0 text-uppercase font-weight-bold">User</h6>
                                                Change Password
                                            </div>
                                        </div>
                                    </a>
                                            ...
                                            <div class="card-body">
                                                <form method="POST" action="{{ route('change_password') }}">
                                                    ...
                                                    <div class="form-group row">
                                                        <label for="password" class="col-md-6 offset-md-2 col-form-label text-md-left">Current Password</label>
                                                    ...
                                                    <div class="form-group row row2">
                                                        <label for="password" class="col-md-6 offset-md-2 col-form-label text-md-left">New Password</label>
                                                    ...
                                                    <div class="form-group row row2">
                                                        <label for="password" class="col-md-6 offset-md-2 col-form-label text-md-left">New Confirm Password</label>
                                                    ...
                                                    <div class="form-group row row2 mb-0">
