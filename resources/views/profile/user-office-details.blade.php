                                            ...
                                            @csrf
                                                <div class="form-row">
                                                    <div class="col-md-4 mb-3">
                                                        ...
                                                        <input type="text" class="form-control" name="emp_id" id="validationCustom01" placeholder="Employee ID" value="{{$user->emp_id}}" required>
                                                    ...
                                                    <div class="col-md-4 mb-3">
                                                        ...
                                                        <div class="input-group">
                                                            <input type="email" class="form-control" name="email" id="validationCustomUsername" placeholder="Office Email Address" aria-describedby="inputGroupPrepend" value="{{$user->email}}" required>
                                                            <div class="invalid-feedback">
                                                    ...
                                                    <div class="col-md-4 mb-3">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" class="form-control" readonly="" disabled="" name="designation" id="validationCustomUsername" placeholder="Designation" aria-describedby="inputGroupPrepend" value="{{$user->designation}}" required>
                                                            <div class="invalid-feedback">
                                                    ...
                                                    <div class="col-md-4 mb-3">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" class="form-control" readonly="" disabled="" name="department" id="validationCustomUsername" placeholder="Department" aria-describedby="inputGroupPrepend" value="{{$user->department}}" required>
                                                            <div class="invalid-feedback">
                                                    ...
                                                    <div class="col-md-4 mb-3">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            value="{{$user->join_date}}" required max="{{date('Y-m-d')}}" min="2021-03-01">
                                                            <div class="invalid-feedback">
                                                    ...
                                                    <div class="col-md-4 mb-3">
                                                        ...
                                                        <div class="input-group">
                                                            <input type="text" class="form-control"  name="reporting_line" id="validationCustomUsername" placeholder="Reporting Line Manager" aria-describedby="inputGroupPrepend" value="{{$user->reporting_line}}" required>
                                                            <div class="invalid-feedback">
                                                    ...
                                                    <div class="col-md-4 mb-3">
                                                        ...
                                                        <div class="input-group">
                                                            <input type="text" class="form-control" name="bank_account_number" id="validationCustomUsername" placeholder="Bank Account Number" aria-describedby="inputGroupPrepend" value="{{$user->bank_account_number}}" required>
                                                            <div class="invalid-feedback">
                                                    ...
                                                    <div class="col-md-4 mb-3">
                                                        ...
                                                        <input type="text" class="form-control" name="v_model_name" id="validationCustom01" placeholder="Model Name" value="{{$user->v_model_name}}" required>
                                                    ...
                                                    <div class="col-md-4 mb-3">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" class="form-control" name="v_model_year" id="validationCustomUsername" placeholder="Model Year" aria-describedby="inputGroupPrepend" value="{{$user->v_model_year}}" required>
                                                            <div class="invalid-feedback">
                                                    ...
                                                    <div class="col-md-4 mb-3">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" class="form-control" name="v_number_plate" id="validationCustomUsername" placeholder="Car Number" aria-describedby="inputGroupPrepend" value="{{$user->v_number_plate}}" required>
                                                            <div class="invalid-feedback">
